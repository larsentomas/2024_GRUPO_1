...
public class TestViaje {
    ...
    public void testGetValorZonaStandar() {
        ...
        Assert.assertEquals("Calculo sin baul y mascota falla", 1200, viaje.getValor(), 0.0000000001); // TODO: Falla

        pedido1 = new Pedido(cliente, 1, true, true, 1, Constantes.ZONA_STANDARD);
        viaje = new Viaje(pedido1, chofer, auto);
        Assert.assertEquals("Calculo con baul y mascota falla", 1650, viaje.getValor(), 0.0000000001); // TODO: Falla
    }
    ...
    public void testGetValorZonaSinAsfaltar() {
        ...
        viaje = new Viaje(pedido1, chofer, auto);
        Assert.assertEquals("Calculo sin baul y mascota falla", 2000, viaje.getValor(), 0.0000000001);

        Pedido pedido2 = new Pedido(cliente, 2, false, false, 4, Constantes.ZONA_SIN_ASFALTAR);
        viaje = new Viaje(pedido2, chofer, auto);
        Assert.assertEquals("Calculo con baul y mascota falla", 3400, viaje.getValor(), 0.0000000001); // TODO: Falla
    }
    ...
    public void testGetValorZonaPeligrosa() {
        ...
        viaje = new Viaje(pedido1, chofer, auto);
        Assert.assertEquals("Calculo sin baul y mascota falla", 2200, viaje.getValor(), 0.0000000001);

        Pedido pedido2 = new Pedido(cliente, 2, true, true, 5, Constantes.ZONA_PELIGROSA);
        viaje = new Viaje(pedido2, chofer, auto);
        Assert.assertEquals("Calculo con baul y mascota falla", 3850, viaje.getValor(), 0.0000000001); // TODO: Falla
    }
